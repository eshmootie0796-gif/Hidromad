...
const slides = [
  ...
  { brand: "ifm", image: "ifm", label: "سنسور و ابزار دقیق", title: "دقت، آغاز هوشمندی.", description: "با هیدروماد، سنسورها و تجهیزات اندازه‌گیری ifm را برای شناخت بهتر فرایندها بررسی کنید.", slogan: "هیدروماد؛ جزئیات را دقیق‌تر ببینید." },
